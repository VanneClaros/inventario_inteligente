...
<div class="form-wrap">
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div class="page-title">Editar <span>Lote #{{ $lote->id }}</span></div>
    </div>
        ...
        <form action="{{ route('lotes.update', $lote->id) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <div class="hint">Opcional. Identificador único del lote para trazabilidad.</div>
                ...
                <div class="col-12">
                    ...
                    <input type="number" name="cantidad"
                        ...
                        value="{{ old('cantidad', $lote->cantidad) }}" min="0">
                    <div class="hint">Cantidad inicial registrada: {{ $lote->cantidad_inicial }} uds.</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="fecha_ingreso"
                        ...
                        value="{{ old('fecha_ingreso', \Carbon\Carbon::parse($lote->fecha_ingreso)->format('Y-m-d')) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="fecha_vencimiento"
                        ...
                        value="{{ old('fecha_vencimiento', \Carbon\Carbon::parse($lote->fecha_vencimiento)->format('Y-m-d')) }}">
