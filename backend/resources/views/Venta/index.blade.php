...
.venta-table thead { background: #111520; }
.venta-table th {
...
.venta-table tbody tr:last-child td { border-bottom: none; }
.venta-table tbody tr:hover td { background: #2e3550; }
.td-id { font-family: 'DM Mono', monospace; color: #5a6280; font-size: 0.8rem; }
.td-cliente { font-weight: 600; color: #f0e6c8; }
.td-total { font-family: 'DM Mono', monospace; color: #c9a84c; font-weight: 700; font-size: 0.9rem; }
...
.btn-detalle:hover { border-color: #c9a84c; color: #c9a84c; }
.btn-eliminar {
...
<div class="pg-wrap">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="page-title">Lista de <span>Ventas</span></div>
        <a href="/ventas/create" class="btn-nuevo">
        ...
        <table class="venta-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="td-cliente">{{ $venta->cliente->nombre }}</span></td>
                    <td><span class="td-total">Bs. {{ number_format($venta->total, 2) }}</span></td>
                    <td><span class="td-fecha">{{ \Carbon\Carbon::parse($venta->fecha)->format('d/m/Y') }}</span></td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="{{ route('ventas.show', $venta->id) }}" class="btn-detalle">
                ...
                <tr>
                    <td colspan="5">
                        <div class="empty-state">
                            <i class="bi bi-receipt fs-2 d-block mb-2" style="color:#c9a84c"></i>
